...
| $$           | $$\  $ | $$| $$  | $$  | $$  | $$            | $$  \ $$| $$  | $$| $$\  $ | $$| $$  \ $$| $$      | $$  \ $$      
| $$$$$$$$     | $$ \/  | $$| $$  | $$ /$$$$$$| $$$$$$$$      | $$$$$$$/|  $$$$$$/| $$ \/  | $$| $$$$$$$/| $$$$$$$$| $$  | $$      
|________/     |__/     |__/|__/  |__/|______/|________/      |_______/  \______/ |__/     |__/|_______/ |________/|__/  |__/ 
                                                                                                    >>BY SILENTKILLER365 ''')
...
class Email_Bomber:
    ...
    def bomb(self):
        try:
            ...
            print(bcolors.RED + f'\n Bombing mode selected sucssesfuly..: {self.mode} and {self.amount} emails ')
        except Exception as e:
            print(f'ERROR: {e}')

    def email(self):
        try:
            print(bcolors.RED + '\n Setting Up E-Mail Provider....')
            ...
            self.fromAddr = str(input(bcolors.GREEN + 'Username <: '))
            self.fromPwd = str(input(bcolors.GREEN + 'Password <: '))
            self.subject = str("")
            self.message = str("")
